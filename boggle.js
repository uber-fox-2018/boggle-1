...
1) generate board ()
    methode ini berguna untuk membuat papan
2) solve ()
...
class BoggleBoardStatik {
    constructor  (kamus,isiBoard){
        this.dataKamus = kamus
        this.dataBoard = isiBoard
    }
    solve () {
...
let isiBoard = [ 'D', 'G', 'H', 'I', 'K', 'L', 'P', 'S' , 'Y', 'E',
                 'U', 'T','E', 'O', 'R', 'N' ]
    
  
let game = new BoggleBoardStatik (kamus,isiBoard)
